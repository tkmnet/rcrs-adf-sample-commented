...
/**
 * Tactics specified in this class is used in the simulation.
 * Tactics is a class that described the behaviour of agents.
 * The specification for invoking this SampleLoader is in launch.sh.
 */
public class SampleLoader extends AbstractLoader {
    /**
     * Return your team name.
     * This description is for tournaments. Therefore, there is usually no problem if you do not change it.
     */
    @Override
    ...
    /**
     * Return Tactics for AmbulanceTeam.
    @Override
